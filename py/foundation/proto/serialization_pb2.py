...
# source: foundation/proto/serialization.proto
...
_SERIALIZEDTYPEONEOF.fields_by_name['record_context'].message_type = foundation_dot_proto_dot_record__pb2._RECORDCONTEXT
_SERIALIZEDTYPEONEOF.fields_by_name['extracted_value'].message_type = foundation_dot_proto_dot_extraction__pb2._EXTRACTEDVALUE
_SERIALIZEDTYPEONEOF.fields_by_name['target_value'].message_type = foundation_dot_proto_dot_targets__pb2._TARGETVALUE
_SERIALIZEDTYPEONEOF.fields_by_name['compared_value'].message_type = foundation_dot_proto_dot_comparison__pb2._COMPAREDVALUE
_SERIALIZEDTYPEONEOF.fields_by_name['entity'].message_type = foundation_dot_proto_dot_entity__pb2._ENTITY
_SERIALIZEDTYPEONEOF.fields_by_name['extracted_value_collection'].message_type = foundation_dot_proto_dot_extraction__pb2._EXTRACTEDVALUECOLLECTION
_SERIALIZEDTYPEONEOF.fields_by_name['target_value_collection'].message_type = foundation_dot_proto_dot_targets__pb2._TARGETVALUECOLLECTION
_SERIALIZEDTYPEONEOF.fields_by_name['compared_value_collection'].message_type = foundation_dot_proto_dot_comparison__pb2._COMPAREDVALUECOLLECTION
_SERIALIZEDTYPEONEOF.fields_by_name['entity_collection'].message_type = foundation_dot_proto_dot_entity__pb2._ENTITYCOLLECTION
...
SerializedTypeOneOf = _reflection.GeneratedProtocolMessageType('SerializedTypeOneOf', (_message.Message,), {
  ...
  '__module__' : 'foundation.proto.serialization_pb2'
