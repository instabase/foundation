...
class Entity(google___protobuf___message___Message):
    ...
    @property
    def children_id(self) -> EntityCollection: ...
    ...
    def __init__(self,
        id : typing___Text,
        children_id : typing___Optional[EntityCollection] = None,
...
class Page(google___protobuf___message___Message):
    ...
    @property
    def bbox(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[geometry_pb2___BBox]: ...

    def __init__(self,
        image_path : typing___Text,
        bbox : typing___Optional[typing___Iterable[geometry_pb2___BBox]] = None,
        ) -> None: ...
    @classmethod
